...
2d |  [Immediate2D](https://github.com/npiegdon/immediate2d)               | **public domain**    | C++ |  2  | zero-configuration, immediate-mode 2D graphics for Windows
...
2d |  [tigr](https://bitbucket.org/rmitton/tigr/src)                       | **public domain**    |C/C++|  2  | quick-n-dirty window text/graphics for Windows and macOS
...
3d |  [debug-draw](https://github.com/glampert/debug-draw)                 | **public domain**    | C++ |**1**| API-agnostic immediate-mode debug rendering
...
3d |  [rjm_raytrace.h](https://github.com/rmitton/rjm)                     | **public domain**    |C/C++|**1**| minimalistic SSE packet raytracer for offline baking
...
3d |  [Swarmz](https://github.com/Cultrarius/Swarmz)                       | **public domain**    | C++ |**1**| swarming/flocking algorithm
3d |  [tinygizmo](https://github.com/ddiakopoulos/tinygizmo)               | **public domain**    | C++ |  2  | gizmo objects for interactively editing 3d transformations
...
3d |**[lightmapper](https://github.com/ands/lightmapper#lightmapper)**     | **public domain**    |C/C++|**1**| use your OpenGL renderer to offline bake lightmaps
3d |**[seamoptimizer](https://github.com/ands/seamoptimizer)**             | **public domain**    |C/C++|**1**| modify lightmap data to hide seams
3d |**[Vertex Cache Optimizer](https://github.com/Sigkill79/sts)**         | **public domain**    |C/C++|**1**| vertex cache optimization of meshes
...
argv |  [parg](https://github.com/jibsen/parg)                               | **public domain**    |  C  |  2  | command-line argument parsing
...
audio |[miniaudio](https://github.com/dr-soft/miniaudio)                  | **public domain**    |C/C++|**1**| Audio playback and capture library
...
crypt |  [Monocypher](https://monocypher.org)                                 | **public domain**    |  C  |  2  | high-quality small cryptography library
crypt |  [TweetNaCl](http://tweetnacl.cr.yp.to/software.html)                 | **public domain**    |  C  |  2  | high-quality tiny cryptography library
...
debug |  [loguru](https://github.com/emilk/loguru)                            | **public domain**    | C++ |**1**| flexible logging
debug |  [pempek_assert.cpp](https://github.com/gpakosz/Assert)               | **WTFPLv2**          | C++ |  2  | flexible assertions
ds |  [avl](https://github.com/etherealvisage/avl)                         | **public domain**    |C/C++|  2  | AVL tree
...
ds |  [minilibs](https://github.com/ccxvii/minilibs)                       | **public domain**    |  C  |  2  | two-file binary tress (also regex, etc)
...
ds |[aArray](https://tse.gratis/aArray/)                               | **public domain**    |  C  |**1**| Arrays/strings: generic, safe
ds |[DG_dynarr.h](https://github.com/DanielGibson/Snippets/)           | **public domain**    |C/C++|**1**| typesafe dynamic arrays (like std::vector) for plain C
...
file |[DG_misc.h](https://github.com/DanielGibson/Snippets/)             | **public domain**    |C/C++|**1**| Daniel Gibson's stb.h-esque cross-platform helpers: path/file, strings
...
game |[app.h](https://github.com/mattiasgustavsson/libs)                 | **public domain**    |C/C++|**1**| Windows-only-but-meant-to-be-cross-platform game-ish framework
...
hw |  [libue](https://github.com/houqp/libue)                              | MIT                  |C/C++|  1  | Helper library for Linux device hot-plug event
hw |[EasyTab](https://github.com/ApoorvaJ/EasyTab)                     | **public domain**    |C/C++|**1**| multi-platform tablet input
image |  [rjm_texbleed.h](https://github.com/rmitton/rjm)                     | **public domain**    |C/C++|**1**| Fills in the color of pixels where alpha==0
image |  EXR [miniexr](https://github.com/aras-p/miniexr)                     | **public domain**    | C++ |  2  | OpenEXR writer, needs header file
image |  EXR [tinyexr](https://github.com/syoyo/tinyexr)                      | BSD                  |C/C++|**1**| EXR image read/write, uses miniz internally
image |  GIF **[gif_load](https://github.com/hidefromkgb/gif_load)**          | **public domain**    |C/C++|**1**| (animated) GIF reader
image |  GIF [gif.h](https://github.com/ginsweater/gif-h)                     | **public domain**    | C++ |**1**| animated GIF writer (can only include once)
image |  GIF [jo_gif.cpp](http://www.jonolick.com/home/gif-writer)            | **public domain**    | C++ |**1**| animated GIF writer (CPP file can also be used as H file)
image |  JPG **[tiny_jpeg.h](https://github.com/serge-rgb/TinyJPEG/)**        | **public domain**    |C/C++|**1**| JPEG encoder
image |  JPG [jpeg-compressor](https://github.com/richgel999/jpeg-compressor) | **public domain**    | C++ |  2  | 2-file JPEG compress, 2-file JPEG decompress
...
image |  PDF [PDFgen](https://github.com/AndreRenaud/PDFGen)                  | **public domain**    |  C  |  2  | PDF writer |
...
image |  PNM [PNM](https://github.com/dmilos/PNM)                             | Apache 2.0           | C++ |  1  | PBM, PGM and PPM reader and writer |
...
image |[cro_mipmap.h](https://github.com/thebeast33/cro_lib)              | **public domain**    |C/C++|**1**| average, min, max mipmap generators
...
json |  [json.h](https://github.com/sheredom/json.h)                         | **public domain**    |C/C++|**1**| JSON parser
...
math |  [fft](https://github.com/wareya/fft)                                 | **public domain**    | C++ |**1**| Fast Fourier Transform |
...
math |  [rfft.h](https://github.com/grego/rfft.h)       | **public domain**    |C/C++|**1**| Fast Fourier Tranform for arbitrary array sizes
...
math |  [Tomas Akenine-Moller snippets](http://tinyurl.com/ht79ndj)          | **public domain**    |C/C++|  2  | various 3D intersection calculations, not lib-ified
...
math |[df](https://github.com/983/df)                                    | **public domain**    |C/C++|**1**| find voronoi region in linear time of size of lattice
math |[nv_voronoi.h](http://www.icculus.org/~mordred/nvlib/)             | **public domain**    |C/C++|**1**| find voronoi regions on lattice w/ integer inputs
math |[rjm_mc.h](https://github.com/rmitton/rjm)                         | **public domain**    |C/C++|**1**| marching cubes triangulator
math |[rnd.h](https://github.com/mattiasgustavsson/libs)                 | **public domain**    |C/C++|**1**| pseudo-random number generation
math |[sobol.h](https://github.com/Marc-B-Reynolds/Stand-alone-junk/)    | **public domain**    |C/C++|**1**| sobol & stratified sampling sequences
...
mesh |  [tinyply](https://github.com/ddiakopoulos/tinyply)                   | **public domain**    | C++ |  2  | PLY mesh file loader
...
misc |  [benchmark.hpp](https://github.com/burner/sweet.hpp/benchmark.hpp)   | LGPL3                | C++ |**1**| micro benchmark library for C++11 and beyond
misc |  [cpp-generators](https://github.com/c-smile/cpp-generators)          | BSD                  | C++ |**1**| generators in C++
misc |  [endianness.h](https://github.com/rofl0r/endianness.h)               | **public domain**    |  C  |**1**| endianness conversion and detection  
misc |  [format.hpp](https.//github.com/burner/sweet.hpp/format.hpp)         | LGPL3                | C++ |**1**| dlang inspired typesafe string formatting
misc |  [ggformat](https://github.com/mikejsavage/ggformat)                  | ISC                  | C++ |  2  | printf replacement
misc |  [Hedley](https://nemequ.github.io/hedley/)                           | **public domain**    |C/C++|**1**| compiler portability, optimization, static analysis, etc.
misc |  [levenshtein](https://github.com/wooorm/levenshtein.c)               | MIT                  |C/C++|  2  | compute edit distance between two strings
misc |  [MakeID.h](http://www.humus.name/3D/MakeID.h)                        | **public domain**    | C++ |**1**| allocate/deallocate small integer IDs efficiently
misc |  [openGA](https://github.com/Arash-codedev/openGA)                    | MPL-2.0              | C++ |**1**| A C++ Generic Algorithm solver library
misc |  [picobench](https://github.com/iboB/picobench)                       | MIT                  | C++ |**1**| microbenchmarking
misc |  [PlusCallback](https://github.com/codeplea/pluscallback)             | zlib                 | C++ |**1**| function/method callbacks
misc |  [random](https://github.com/effolkronium/random)                     | MIT                  | C++ |**1**| convenient API for random
misc |  [RGFW](https://github.com/ColleagueRiley/RGFW)                        | zlib                 |C/C++|**1**| A multi-platform single-header user-friendly GUI framework as an alternative to GLFW 
misc |  [sili-toolchain](https://github.com/EimaMei/sili-toolchain)          | **public domain**    |C/C++|**1**| C toolchain for modern C programming, strings, arrays, files, threading, ect
misc |  [sokol_time.h](https://github.com/floooh/sokol)                      | MIT                  |C/C++|**1**| cross-platform time measurement
misc |  [stmr](https://github.com/wooorm/stmr.c)                             | MIT                  |  C  |  2  | extract English word stems
misc |  [tinyformat](https://github.com/c42f/tinyformat)                     | Boost                | C++ |**1**| typesafe printf
...
misc |[process.h](https://github.com/sheredom/process.h)                 | **public domain**    |C/C++|**1**| process control API
misc |[ubench.h](https://github.com/sheredom/ubench.h)                   | **public domain**    |C/C++|**1**| microbenchmarking 
...
net |  [yocto](https://github.com/tom-seddon/yhs)                           | **public domain**    |C/C++|  2  | non-production-use HTTP server
...
net |[http](https://github.com/mattiasgustavsson/libs)                  | **public domain**    |C/C++|**1**| HTTP get/post
net |[sts_net](https://github.com/kieselsteini/sts)                     | **public domain**    |C/C++|**1**| cross-platform socket wrapper (socket sets and packet API)
net |[zed_net](https://github.com/Smilex/zed_net)                       | **public domain**    |C/C++|**1**| cross-platform socket wrapper
...
parse |  [inih](https://github.com/benhoyt/inih)                              | BSD                  |C/C++|  2  | .ini file parser
parse |  [minilibs](https://github.com/ccxvii/minilibs)                       | **public domain**    |  C  |  2  | two-file regex (also binary tree, etc)
...
parse |  [Unformat](https://github.com/adamyaxley/Unformat)                   | **public domain**    | C++ |**1**| parses formatted strings (reverse of std::format)
parse |[ini.h](https://github.com/mattiasgustavsson/libs)                 | **public domain**    |C/C++|**1**| .ini file parser
...
profile |  [MicroProfile](https://github.com/jonasmr/microprofile)              | **public domain**    | C++ | 2-4 | CPU (and GPU?) profiler, 1-3 header files, uses miniz internally
profile |  [prof](https://github.com/cyrus-and/prof)                            | MIT                  |C/C++|**1**| profiler for Linux
profile |  [Remotery](https://github.com/Celtoys/Remotery)                      | Apache 2.0           |C/C++|  2  | CPU/GPU profiler Win/Mac/Linux, using web browser for viewer
...
serial |  [archive](https://github.com/voidah/archive)                         |**public domain**     | C++ |**1**| binary serialize & deserlize w/ STL support
...
string |  [Obfuscate](https://github.com/adamyaxley/Obfuscate)                 | **public domain**    | C++ |**1**| Guaranteed compile-time string literal obfuscation library for C++14
...
string |[DG_misc.h](https://github.com/DanielGibson/Snippets/)             | **public domain**    |C/C++|**1**| Daniel Gibson's stb.h-esque cross-platform helpers: path/file, strings
string |[gb_string.h](https://github.com/gingerBill/gb)                    | **public domain**    |C/C++|**1**| dynamic strings
string |[Str.h](https://github.com/ocornut/Str)                            | **public domain**    | C++ |**1**| Simple C++ string type with an optional local buffer
string |[strpool.h](https://github.com/mattiasgustavsson/libs)             | **public domain**    |C/C++|**1**| string interning
string |[utf8](https://github.com/sheredom/utf8.h)                         | **public domain**    |C/C++|**1**| UTF-8 string library
...
test |  [catch2](https://github.com/catchorg/Catch2/)                        | Boost                | C++ |**1**| unit testing
test |  [catch](https://github.com/philsquared/Catch)                        | Boost                | C++ |**1**| unit testing
test |  [clove-unit](https://github.com/fdefelici/clove-unit)                | MIT                  |  C  |**1**| unit testing
test |  [doctest](https://github.com/onqtam/doctest)                         | MIT                  | C++ |**1**| unit testing
test |  [fctx](https://github.com/imb/fctx)                                  | BSD                  |C/C++|**1**| unit testing
test |  [greatest](https://github.com/silentbicycle/greatest)                | iSC                  |  C  |**1**| unit testing
test |  [hippomocks](https://github.com/dascandy/hippomocks)                 | LGPL                 | C++ |**1**| unit testing
test |  [minctest](https://github.com/codeplea/minctest)                     | zlib                 |  C  |**1**| unit testing
test |  [munit](https://github.com/nemequ/munit)                             | MIT                  |  C  |**1**| unit testing
test |  [picotest](https://github.com/colinbarry/picotest)                   | MIT                  |C/C++|**1**| unit testing
test |  [SPUT](http://www.lingua-systems.com/unit-testing/)                  | BSD                  |C/C++|**1**| unit testing
test |  [trompeloeil](https://github.com/rollbear/trompeloeil)               | Boost                | C++ |**1**| unit testing
test |  [utest](https://github.com/evolutional/utest)                        | MIT                  |C/C++|**1**| unit testing
test | [test.h](https://github.com/dyeo/dyeo.h/blob/main/test.h) | **PD/MIT** | C | **1** | unit testing
test |[labrat](https://github.com/squarewave/labrat)                     | **public domain**    |C/C++|**1**| unit testing
test |[Rexo](https://github.com/christophercrouzet/rexo)                 | **public domain**    |C/C++|**1**| framework for C89/C++ featuring automatic registration of tests and a polished API
test |[utest.h](https://github.com/sheredom/utest.h)                     | **public domain**    |C/C++|**1**| unit testing
test |[walter](https://github.com/ir33k/walter)                          | **public domain**    |  C  |**1**| unit testing
text  2d|  [rang](https://github.com/agauniyal/rang)                            | **public domain**    | C++ |**1**| cross-platform colored console text
text  2d|  [ssfn.h](https://gitlab.com/bztsrc/scalable-font)                    | MIT                  |C/C++|**1**| scalable/bitmap/pixmap font renderer
...
thread |[thread.h](https://github.com/mattiasgustavsson/libs)              | **public domain**    |C/C++|**1**| cross-platform thread primitives
...
ui |  [libcmdf](https://github.com/ronen25/libcmdf)                        | **public domain**    | C   |**1**| a small library for writing CLI applications
...
ui |  [nuklear](https://github.com/Immediate-Mode-UI/Nuklear)              | **public domain**    |C/C++|**1**| minimal GUI toolkit
...
vector |  [linalg.h](https://github.com/sgorsten/linalg)                       | **public domain**    | C++ |**1**| vector/matrix/quaternion math
...
vector |[ccVector.h](https://github.com/jobtalle/ccVector)                 | **public domain**    |C/C++|**1**| Vector, quaternion and matrix math
vector |[gb_math](https://github.com/gingerBill/gb/blob/master/gb_math.h)  | **public domain**    |C/C++|**1**| Vector, quaternion and matrix math w/o math.h
vector |[Handmade Math](https://github.com/StrangeZak/Handmade-Math)       | **public domain**    |C/C++|**1**| vector math
video |  [jo_mpeg](http://www.jonolick.com/home/mpeg-video-writer) / [(converted to C)](https://blog.frost.kiwi/jo-mpeg-in-c)            | **public domain**    | C/C++ |**1**| MPEG file writer
