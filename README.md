...
|  [SFML](https://github.com/SFML/SFML)                                 |  Zlib license        | C++ |  2  | simple, fast, cross-platform and object-oriented multimedia API. It provides access to windowing, graphics, audio and network 
